...
export default function ClientHistory({ onNavigate }: ClientHistoryProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-24 space-y-16">
      ...
      {error && (
        <div className="bg-primary-red/10 border border-primary-red/20 p-6 flex items-center gap-4 text-primary-red">
              ...
              >
                ...
                <div className="text-right space-y-2">
                  <div className="space-y-0.5">
                    <p className="text-secondary-text font-sans font-bold uppercase tracking-[0.2em] text-[10px]">
                      Sous-total : {Number(order.total_amount - (order.livraison_frais || 0)).toFixed(0)} MAD
                    </p>
                    {order.order_type === 'livraison' && (
                      <p className="text-secondary-text font-sans font-bold uppercase tracking-[0.2em] text-[10px]">
                        Livraison : {Number(order.livraison_frais || 0).toFixed(0)} MAD
                      </p>
                    )}
                  </div>
